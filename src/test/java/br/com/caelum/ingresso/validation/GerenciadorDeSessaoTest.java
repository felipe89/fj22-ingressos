...
public class GerenciadorDeSessaoTest {
	...
	private Sessao sessoaDasDezoito; 
	...
	public void preparaSessões() {
		...
		this.sessoaDasDezoito = new Sessao(LocalTime.parse("18:00:00"), sala3D, hulk);
	}
	@Test
	...
	public void garanteQueNaoDevePermitirSessoesTerminandoDentroDoHorarioDeUmaSessaoJaExistente() {
		...
		Sessao sessao = new Sessao(sessaoDasDez.getHorario().minusHours(1), sala3D, hulk);
	...
	public void garanteQueNaoDevePermitirSessoesIniciandoDentroDoHorarioDeUmaSessaoJaExistente() {
		...
		Sessao sessao = new Sessao(sessaoDasDez.getHorario().plusHours(1), sala3D, hulk);
		Assert.assertFalse(gerenciador.cabe(sessao));
	}

	@Test
	public void garanteQueDevePermitirUmaInsercaoEntreDoisFilmes() {
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez, sessoaDasDezoito);
	...
	public void garanteQueDeveNaoPermitirUmaSessaoQueTerminaNoProximoDia() {
		...
		Sessao sessaoQueTerminaAmanha = new Sessao(LocalTime.parse("23:00:00"), sala3D, hulk);
